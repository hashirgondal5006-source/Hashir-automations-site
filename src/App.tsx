...
function NavBar({ refs }) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-800/60 bg-slate-950/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        >
          <span
            className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-violet-500 to-blue-500 text-sm font-bold text-white"
...
function Hero({ sectionRef, refs }) {
  return (
    <section
      ref={sectionRef}
      className="relative mx-auto flex max-w-6xl flex-col gap-14 px-6 pb-24 pt-36 md:flex-row md:items-center md:pt-44"
    >
      <div
...
function Footer() {
  return (
    <footer className="border-t border-slate-800/60 px-6 py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 text-center font-body text-xs text-slate-500 sm:flex-row sm:text-left">
